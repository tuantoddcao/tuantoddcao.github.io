...
<div class="city-wrapper">
  <div class="city-layer">
    ...
    <a href="about.html" class="city-icon icon-contact">
    ...
    <a href="about.html" class="city-icon icon-open-science">
    ...
    <a href="about.html" class="city-icon icon-radio">
      <img src="image/radio.svg" alt="Media">
      <span class="city-label">Misc.</span>
    </a>
